...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["README.md".freeze, "LICENSE".freeze, "lib/jwt.rb".freeze, "lib/jwt/json.rb".freeze]
  s.files = ["LICENSE".freeze, "README.md".freeze, "lib/jwt.rb".freeze, "lib/jwt/json.rb".freeze]
